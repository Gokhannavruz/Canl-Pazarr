...
class _SubscriptionPageState extends State<SubscriptionPage> {
            ...
            Row(
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Yearly Subscription",
                        // 'Product title',
                        style: TextStyle(
                            fontWeight: FontWeight.w500,
                            color: Colors.white,
  ...
  Future<void> confirmPriceChange(BuildContext context, String sku) async {
    final ProductDetails productDetails = findProductDetail(sku)!;
...
///Save purchaseDetails in DB
  ...
  // update current user ispremium status in firestore
  updatedTransactions() async {
